...
public class PostEffectsBase : MonoBehaviour
{
	public override Material CheckShaderAndCreateMaterial(Shader s, Material m2Create)
	{
		...
		else if (!Object.op_Implicit((Object)(object)s))
		{
		...
		else
		{
			...
			((Object)m2Create).hideFlags = (HideFlags)13;
	...
	public override void ReportNotSupported()
	{
		Debug.LogError((object)("The image effect " + ((Object)this).ToString() + " on " + ((Object)this).name + " is not supported on this platform!"));
		((Behaviour)this).enabled = false;
	}

	public override void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		Debug.Log((object)"OnRenderImage in Base called ...");
	}

	public override void DrawLowLevelPlaneAlignedWithCamera(float dist, RenderTexture source, RenderTexture dest, Material material, Camera cameraForProjectionMatrix)
	{
	...
	public override void DrawLowLevelQuad(float x1, float x2, float y1, float y2, RenderTexture source, RenderTexture dest, Material material)
	{
		RenderTexture.active = dest;
		material.SetTexture("_MainTex", (Texture)(object)source);
		bool flag = true;
