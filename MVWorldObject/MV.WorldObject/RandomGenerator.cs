...
public class RandomGenerator
{
	...
	{
		IncrementRandomIndex();
		ushort num = randomNumbers[randomIndex % randomNumbers.Length];
		ushort num2 = randomNumbers[~randomIndex % randomNumbers.Length];
		int num3 = num;
		num3 <<= 16;
		return num3 + num2;
	}

	private void IncrementRandomIndex()
	{
		randomIndex = seed * step * round;
		step++;
