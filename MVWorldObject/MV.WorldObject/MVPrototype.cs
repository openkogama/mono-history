...
public class MVPrototype
{
	...
	public bool IsEmpty => ((Dictionary<IntVector, byte[]>)Data[(byte)50]).Count == 0;
	...
	public virtual MVPrototype DeepCopy()
	{
		...
		Dictionary<IntVector, byte[]> dictionary = (Dictionary<IntVector, byte[]>)Data[(byte)50];
		...
		mVPrototype.Data[(byte)50] = dictionary2;
		return mVPrototype;
	}
}
