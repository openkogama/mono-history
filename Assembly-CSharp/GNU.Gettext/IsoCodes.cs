...
internal static class IsoCodes
{
	...
	public static IEnumerable<IsoCode> KnownLanguages => isoLanguagesByLang.Values;

	public static IEnumerable<IsoCode> KnownCountries => isoCountriesByCountry.Values;

	static IsoCodes()
	{
		IsoCode[] array = new IsoCode[165]
		{
			new IsoCode("aa", "Afar"),
		...
		IsoCode[] array2 = array;
		foreach (IsoCode isoCode in array2)
		{
			isoLanguagesByCode.Add(isoCode.Iso, isoCode);
			isoLanguagesByLang.Add(isoCode.Name, isoCode);
		}
		IsoCode[] array3 = new IsoCode[239]
		{
		...
		IsoCode[] array4 = array3;
		foreach (IsoCode isoCode2 in array4)
		{
			isoCountriesByCode.Add(isoCode2.Iso, isoCode2);
			isoCountriesByCountry.Add(isoCode2.Name, isoCode2);
		}
	}
