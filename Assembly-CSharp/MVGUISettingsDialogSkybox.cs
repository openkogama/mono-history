...
public class MVGUISettingsDialogSkybox : MVGUIDynamicSettingsDialog
{
	...
	{
		dialogFactory.CreateCustomDialog("Prefabs/GUI/Box Settings Dialogs/SkyboxSettingsDialog", TM._("Skybox")).AddPositiveButton(TM._("Ok")).AddNegativeButton(TM._("Cancel"))
