...
public class FloatAttribute : NamedThemeAttribute<float>
{
	...
	[Header("Dependencies")]
	[SerializeField]
	private ThemeFloatSlider sliderPrefab;
	...
	{
		ThemeFloatSlider themeFloatSlider = UnityEngine.Object.Instantiate(sliderPrefab);
		themeFloatSlider.Initialize(this, OnSettingsChanged);
		return (RectTransform)themeFloatSlider.transform;
	}
}
