...
public class BoolAttribute : NamedThemeAttribute<bool>
{
	...
	[Header("Dependencies")]
	[SerializeField]
	private ThemeToggle togglePrefab;
	...
	{
		ThemeToggle themeToggle = UnityEngine.Object.Instantiate(togglePrefab);
		themeToggle.Initialize(this, OnSettingsChanged);
		return (RectTransform)themeToggle.transform;
	}
}
