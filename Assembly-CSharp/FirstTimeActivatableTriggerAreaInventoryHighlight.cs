...
public class FirstTimeActivatableTriggerAreaInventoryHighlight : FirstTimeActivatableElementBase
{
	...
	private InventoryCategoryType itemCategory = InventoryCategoryType.AdvancedLogic;
	...
	protected int GetItemSlot(int iteration)
	{
		...
		foreach (InventorySlot value in dictionary.Values)
		{
			...
			if (!(component == null))
			{
				...
				else if (component.DocumentationType == MVWorldObjectDocumentationType.TriggerCube)
				{
