...
public class DesktopPlayModeController : ModeControllerBase, IPlayModeUI, ICanvasController, IEventSystemHandler, ILeaveEditPlayModeHandler, IActivateUIElement
{
	...
	[SerializeField]
	private WinningConditionControl winningConditionControl;
	...
	[SerializeField]
	private PersistentUI persistentUIPrefab;
	...
	public override void Initialize()
	{
		...
		persistentUI = UnityEngine.Object.Instantiate(persistentUIPrefab);
		persistentUI.transform.SetParent(playModeState.transform, worldPositionStays: false);
		persistentUI.transform.SetAsFirstSibling();
		...
		winningConditionControl.Initialize(persistentUI.TransformToInstantiateWinningConditionIn, lobbyState);
	}
