...
public static class LocalizedEnums
{
	...
	private static class MVJoinStateLS
	{
		...
		private static void Init(Dictionary<int, string> map)
		{
			...
			map.Add(58, TM._("Fetching Materials"));
			map.Add(60, TM._("Fetching Item Types"));
			map.Add(59, TM._("Fetching Ownership Types"));
			map.Add(65, TM._("Fetching Inventory"));
			map.Add(67, TM._("Fetching BuiltIn Items"));
			map.Add(66, TM._("Fetching Shop Inventory"));
			map.Add(68, TM._("Fetching Avatar Shop Inventory"));
			map.Add(62, TM._("Fetching Game Snapshot"));
			map.Add(61, TM._("Setup User Play mode"));
			map.Add(64, TM._("Fetching Friends"));
			map.Add(63, TM._("Setting Actor Ready"));
			map.Add(70, TM._("Fetching Active Avatar"));
			map.Add(69, TM._("Initialize Avatar Edit"));
			map.Add(87, TM._("Getting Profile Meta Data"));
			map.Add(90, TM._("Getting Planet Profile Data"));
			map.Add(97, TM._("Getting Project Earnings"));
			map.Add(98, TM._("Getting Top High Scores"));
			map.Add(99, TM._("Getting KoGaMa VAT"));
			map.Add(100, TM._("Getting Subscription Perk Data"));
			map.Add(101, TM._("Setting Up User"));
			map.Add(102, TM._("Setting Up User"));
		}
	}
