...
public class MaterialDescription
{
	...
	public static readonly MaterialDescription[] materialDescriptions = new MaterialDescription[60]
	{
		...
		new MaterialDescription(TM._("Ice"), TM._("The ice material is slippery and super fun. Players can use it for ice slides, parkour and crazy rollercoasters."), MaterialSpecialProperty.Slippery),
		...
		new MaterialDescription(TM._("Zig-zag"), TM._("This standard material can be used to create games, cube models and avatars.")),
		...
		new MaterialDescription(TM._("Black Ice"), TM._("The Black Ice material is slippery and super fun. Players can use it for ice slides, parkour and crazy rollercoasters."), MaterialSpecialProperty.Slippery),
		...
		new MaterialDescription(TM._("Soft Destructible"), TM._("This material can easily be destroyed by weapons, explosives and when it's hit by players or vehicles. You can hides treasures for the players with this."), MaterialSpecialProperty.Destructable),
