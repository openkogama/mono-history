...
public struct ObscuredVector3
{
	...
	private static int cryptoKey = RandonGen.RandomInt(int.MinValue, int.MinValue);
	...
	public static RawEncryptedVector3 Encrypt(Vector3 value, int key)
	{
		...
		RawEncryptedVector3 result = default;
	...
	private Vector3 InternalDecrypt()
	{
		...
		vector.x = ObscuredFloat.Decrypt(hiddenValue.x, key);
		vector.y = ObscuredFloat.Decrypt(hiddenValue.y, key);
		vector.z = ObscuredFloat.Decrypt(hiddenValue.z, key);
