...
public struct ObscuredQuaternion
{
	...
	private Quaternion InternalDecrypt()
	{
		...
		quaternion.x = ObscuredFloat.Decrypt(hiddenValue.x, key);
		quaternion.y = ObscuredFloat.Decrypt(hiddenValue.y, key);
		quaternion.z = ObscuredFloat.Decrypt(hiddenValue.z, key);
		quaternion.w = ObscuredFloat.Decrypt(hiddenValue.w, key);
