...
public class UXToggleIconButton : MonoBehaviour
{
	...
	public bool useFadeOn;

	public bool useFadeOff;
	...
	public bool ToggleState
	{
		...
		set
		{
			if (value != toggleState)
			{
				toggleState = value;
				UpdateMaterial();
				NotifyOnToggle(toggleState);
			}
		}
	}

	public UXToggleIconButton()
	{
	...
	public void Awake()
	{
		...
		if (useFadeOn)
		{
			component.materials.Add(materialOn);
		}
		if (useFadeOff)
		{
			component.materials.Add(materialOff);
		}
		...
		component3.OnMouseUp = (UXMouseClickObject.OnMouseUpDelegate)Delegate.Combine(component3.OnMouseUp, new UXMouseClickObject.OnMouseUpDelegate(OnClick));
	}
	...
	private void NotifyOnToggle(bool toggleState)
	{
		if (OnToggle != null)
		{
	...
	{
		((Component)this).renderer.material = ((!toggleState) ? materialOff : materialOn);
	}
	...
	private Mesh BuildMesh()
	{
		...
		array2[5] = 2;
		Mesh val = new Mesh();
		((Object)val).name = "UIToggleIconButton Mesh";
		val.vertices = array;
		val.uv = array3;
