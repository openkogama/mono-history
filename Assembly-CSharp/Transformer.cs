...
public class Transformer : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (Input.GetKey((KeyCode)48) && Input.GetKey((KeyCode)113))
		{
			worldPos1 = ((Component)this).transform.TransformPoint(localPos);
			worldPos2 = Vector4.op_Implicit(((Component)this).transform.localToWorldMatrix * Vector4.op_Implicit(localPos));
			Debug.Log((object)string.Concat(new object[4] { "Transform fun: ", worldPos1, " matrix: ", worldPos2 }));
		}
		DrawArrow(worldPos1);
	}
