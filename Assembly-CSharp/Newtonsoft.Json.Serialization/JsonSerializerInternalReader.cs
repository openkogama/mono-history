			...
			do
			{
				...
				if (string.Equals(a, "$ref", StringComparison.Ordinal))
				{
					...
					if (text2 != null)
					{
						...
						return Serializer.ReferenceResolver.ResolveReference(this, text2);
					}
					flag = true;
				}
				else if (string.Equals(a, "$type", StringComparison.Ordinal))
				{
					...
					if (((!typeNameHandling.HasValue) ? Serializer.TypeNameHandling : typeNameHandling.Value) != TypeNameHandling.None)
					{
