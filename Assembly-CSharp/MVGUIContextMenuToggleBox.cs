...
public class MVGUIContextMenuToggleBox : UXViewScript
{
	...
	public static MVGUIContextMenuToggleBox New()
	{
		Object val = Object.Instantiate(Resources.Load("Prefabs/GUI/Box Settings Dialogs/ContextMenuToggleBox"));
		MVGUIContextMenuToggleBox menu = ((GameObject)((val is GameObject) ? val : null)).GetComponent<MVGUIContextMenuToggleBox>();
		menu.Initialize();
