...
public class FirstTimeActivatableTeamNamePopup : FirstTimeActivatableElementBase
{
	[SerializeField]
	...
	private InventoryCategoryType itemCategory = InventoryCategoryType.Logic;
	...
	public override bool CanShow
	{
		get
		{
			...
			bool flag3 = MVGameControllerBase.Game.TeamManager.GetTeamList().Count > 1;
			return !isBlocked && activeInHierarchy && flag2 && flag && flag3;
		}
	}
	...
	protected int GetItemSlot(int iteration)
	{
		...
		foreach (InventorySlot value in dictionary.Values)
		{
			...
			if (!(component == null))
			{
				...
				else if (component.DocumentationType == MVWorldObjectDocumentationType.TeamEditor)
				{
