...
public abstract class ScoreBoardBase : MonoBehaviour
{
	...
	private void SetPlacementTextForIndex(int index)
	{
		...
		{
		case 0:
			scoreBoardPlayerData[index].PlacementText.text = "1";
			break;
		case 1:
			scoreBoardPlayerData[index].PlacementText.text = "2";
			break;
		case 2:
			scoreBoardPlayerData[index].PlacementText.text = "3";
			break;
		default:
			scoreBoardPlayerData[index].PlacementText.text = "4";
			break;
		}
	}
