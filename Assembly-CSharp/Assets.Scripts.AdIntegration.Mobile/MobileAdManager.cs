...
public class MobileAdManager : IAdManager, IUpdatecontrollerSubscriberUpdate, IUpdatecontrollerSubscriberBase
{
	...
	private class InterstitialAdResultHandler
	{
		...
		public InterstitialAdResultHandler(Action<InterstitialAdResult> interstitialCallback)
		{
	...
	private class RewardedAdResultHandler
	{
		...
		public RewardedAdResultHandler(Action<RewardedAdResult> rewardedAdCallback)
		{
			this.rewardedAdCallback = rewardedAdCallback;
		}
	...
	{
		private bool isAmerican = true;

		private bool isEuropean = true;

		private bool isChild;

		private bool hasConsented;

		public bool DoTagForChildDirectedTreatment => isChild && isAmerican;

		public bool TagForUnderAgeOfConsent => isChild && isEuropean;

		public bool HasConsented
		{
			get
			{
				bool flag = !isEuropean || !isChild;
				bool flag2 = isEuropean || isAmerican;
				return (hasConsented && flag) || !flag2;
			}
		}

		public bool IsGDPRConsentRequired => isEuropean;
	}
	...
	private static ConsentAndCompliance consentAndCompliance = new ConsentAndCompliance();
	...
	private void SetupConsentAndCompliance()
	{
	...
	public void RequestRewardedAd(Action<RewardedAdResult> rewardedAdCallback, string context)
	{
		...
		else
		{
			...
			rewardedAdResultHandler = new RewardedAdResultHandler(rewardedAdCallback);
	...
	public void RequestInterstitial(Action<InterstitialAdResult> interstitialCallback, string context)
	{
		...
		else
		{
			...
			interstitialAdResultHandler = new InterstitialAdResultHandler(interstitialCallback);
	...
	public override string ToString()
	{
		...
		return internalAdManagerState.ToString();
	}
